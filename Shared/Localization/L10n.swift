...
extension L10nStrings {
    ...
    static let english = L10nStrings(
        ...
        tcpDescription: "Attempts a TCP connection and verifies it does not immediately close",
    ...
    static let traditionalChinese = L10nStrings(
        ...
        portLabel: "端口",
        portOptional: "端口 (可選)",
        tcpDescription: "將嘗試建立 TCP 連接，並確認連線不會立即中斷",
    ...
    static let simplifiedChinese = L10nStrings(
        ...
        portLabel: "端口",
        portOptional: "端口（可选）",
        tcpDescription: "尝试建立 TCP 连接，并确认连接不会立即中断",
